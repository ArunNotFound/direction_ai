...
- **Why Fable-Dart is Aborted:** Dart represents floating-point numbers as 64-bit doubles. Transpiling F#'s `System.Decimal` (true 128-bit exact decimal arithmetic) forced reliance on `double.parse` or fragile numeric mocks.
