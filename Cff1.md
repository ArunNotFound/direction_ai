...
- [OpenMetadata Table JSON Schema](https://github.com/open-metadata/OpenMetadata/blob/main/openmetadata-spec/src/main/resources/json/schema/entity/data/table.json)
- [OpenMetadata custom properties](https://docs.open-metadata.org/latest/how-to-guides/guide-for-data-users/custom)
...
- [Dhall safety guarantees and limits](https://docs.dhall-lang.org/discussions/Safety-guarantees.html)
- [Official Dhall integration options](https://docs.dhall-lang.org/howtos/How-to-integrate-Dhall.html)
- [Dhall standard grammar and numeric types](https://github.com/dhall-lang/dhall-lang/blob/master/standard/dhall.abnf)
